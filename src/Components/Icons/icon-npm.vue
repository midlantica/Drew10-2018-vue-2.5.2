<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="88" height="60" viewBox="0 0 88 60">
    ...
    <g fill="none" fill-rule="evenodd">
      <path fill="#000" fill-opacity=".1" fill-rule="nonzero" d="M38.743 36.825c21.397 0 38.743-5.11 38.743-11.412C77.486 19.11 60.14 14 38.743 14 17.346 14 0 19.11 0 25.413s17.346 11.412 38.743 11.412z" filter="url(#a)" transform="translate(5 16)"/>
      <path fill="#CB3837" d="M12 16h66v23.143H45V43H30.333v-3.857H12"/>
